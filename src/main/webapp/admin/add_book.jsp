						...
						<form action="../BookAdd" method="post"
							...
							<div class="form-group">
								<label for="exampleInputEmail1">Tên sách</label> <input
									name="bname" type="text" required="required" class="form-control"
									id="exampleInputEmail1" aria-describedby="emailHelp">
							</div>

							<div class="form-group mt-3">
								<label for="exampleInputEmail1">Tên tác giả</label> <input
									name="author" type="text" required="required" class="form-control"
									id="exampleInputEmail1" aria-describedby="emailHelp">
							</div>

							<div class="form-group mt-3">
								<label for="exampleInputEmail1">Giá </label> <input name="price"
									type="text" class="form-control" required="required" id="exampleInputEmail1"
									aria-describedby="emailHelp">
							</div>

							<div class="form-group mt-3">
								<label for="inputState" >Loại sách</label> <select
									id="inputState" name="btype" class="form-control" required="required">
